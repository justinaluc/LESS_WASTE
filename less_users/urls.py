...
from less_users.views import HomeView, RegisterView, ProfileView, MyChallengesView, MyChallengeView, activate_view, event_view
...
urlpatterns = [
    ...
    path('my_challenges/<int:pk>/', MyChallengeView.as_view(template_name='less_users/my_challenge.html'), name='my_challenge'),
